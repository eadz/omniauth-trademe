...
module OmniAuth
  module Strategies
    ...
    class Trademe < OmniAuth::Strategies::OAuth
      ...
      def raw_info
        @raw_info ||= MultiJson.decode(access_token.get("#{site}/v1/MyTradeMe/Summary.json").body)
      end
    ...
    class TrademeSandbox < Trademe
      ...
      default_options[:client_options][:request_token_url] = 'https://secure.tmsandbox.co.nz/Oauth/RequestToken'
      default_options[:client_options][:access_token_url] = 'https://secure.tmsandbox.co.nz/Oauth/AccessToken'
      default_options[:client_options][:authorize_url] = 'https://secure.tmsandbox.co.nz/Oauth/Authorize'
    end
  end
end